...
function loadReadState() {
    try {
        if (sessionStorage.getItem('algoritma_tujuanRead') === 'true') {
            materiOpened = true;
        }
        if (sessionStorage.getItem('algoritma_caraRead') === 'true') {
            caraOpened = true;
        }
    } catch (e) {
...
function closeCPModal() {
    materiOpened = true;
    try { sessionStorage.setItem('algoritma_tujuanRead', 'true'); } catch (e) {}
...
function closeCaraModal() {
    caraOpened = true;
    try { sessionStorage.setItem('algoritma_caraRead', 'true'); } catch (e) {}
...
function updateSlide() {
    ...
    if (activeSlide) {
        ...
        activeSlide.classList.add('block');
    }
