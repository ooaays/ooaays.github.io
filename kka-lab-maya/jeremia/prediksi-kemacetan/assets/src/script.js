...
function loadReadState() {
    try {
        if (sessionStorage.getItem('traffic_tujuanRead') === 'true') {
            materiOpened = true;
        }
        if (sessionStorage.getItem('traffic_caraRead') === 'true') {
            caraOpened = true;
        }
    } catch (e) {
...
function closeCPModal() {
    materiOpened = true;
    try { sessionStorage.setItem('traffic_tujuanRead', 'true'); } catch (e) {}
...
function closeCaraModal() {
    caraOpened = true;
    try { sessionStorage.setItem('traffic_caraRead', 'true'); } catch (e) {}
