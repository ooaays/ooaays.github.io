...
function loadReadState() {
    try {
        if (sessionStorage.getItem('nlp_tujuanRead') === 'true') {
            materiOpened = true;
        }
        if (sessionStorage.getItem('nlp_caraRead') === 'true') {
            caraOpened = true;
        }
    } catch (e) {
...
function closeCPModal() {
    materiOpened = true;
    try { sessionStorage.setItem('nlp_tujuanRead', 'true'); } catch (e) {}
...
function closeCaraModal() {
    caraOpened = true;
    try { sessionStorage.setItem('nlp_caraRead', 'true'); } catch (e) {}
