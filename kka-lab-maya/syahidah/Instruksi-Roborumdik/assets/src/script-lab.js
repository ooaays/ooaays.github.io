    ...
    function renderScript() {
        ...
        appData[activeSprite].scripts.forEach((block, index) => {
            ...
            else if (block.type === 'show') leftContent.innerHTML = `<i class='fa-solid fa-eye mr-2'></i>Tampilkan`; else if (block.type === 'hide') leftContent.innerHTML = `<i class='fa-solid fa-eye-slash mr-2'></i>Sembunyikan`; 
